...
const footerLinks = {
  ...
  Company: [ "Blog",  "Contact"], //"Careers","About",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Omnichannel communication platform powered by AI.
            </p>
          </div>
            ...
            <div key={category}>
              ...
              <ul className="space-y-2">
                {links.map((link) => {
                  ...
                  else if (link === "Terms of Service") href = "/terms-of-service";
                  else if (link === "Cookie Policy") href = "/cookie-policy";
                  ...
                  else if (link === "Documentation") href = "/documentation";
                  else if (link === "Help Center") href = "/help-center";
                  else if (link === "Community") href = "/community";
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.facebook.com/vaakuos/" target='_blank' className="text-muted-foreground hover:text-foreground transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.linkedin.com/company/vaakuos/" target='_blank' className="text-muted-foreground hover:text-foreground transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
