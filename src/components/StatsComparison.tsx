      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center mb-16 px-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Compare benchmarked results across different recovery strategies and see how 
            integrated retrieval outperforms fragmented tools.
          </p>
        </div>
                ...
                <div className="space-y-6 flex-grow">
                  ...
                  <div className="pt-6 border-t border-border mt-auto">
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground text-xs font-bold uppercase tracking-wider">Growth Lift</span>
                      <span className={`text-2xl font-black ${stat.highlight ? "text-primary" : "text-slate-900"}`}>
                        {stat.growth}
                      </span>
                    </div>
                  </div>
...
const MetricRow = ({ label, value, icon, percentage, highlight }: any) => (
  <div>
    <div className="flex justify-between items-center mb-2">
      ...
      <span className={`font-bold text-sm ${highlight ? "text-primary" : "text-slate-900"}`}>{value}</span>
    </div>
    <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
      <motion.div 
        ...
        className={`h-full transition-all duration-1000 ease-out ${highlight ? "bg-primary" : "bg-slate-400"}`} 
      />
    </div>
  </div>
);
