        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-20 text-red-500">
              <p>Error loading article. Article might not exist or there was a network error.</p>
            </div>
          ) : (
            <article>
              <header className="mb-12">
                ...
                <div className="flex items-center justify-between py-6 border-y border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold">{post.author?.name || "Admin"}</p>
              ...
              {post.featured_image && (
                <div className="mb-12 rounded-3xl overflow-hidden border border-border">
                  <img src={post.featured_image} alt={post.title} className="w-full h-auto aspect-video object-cover" />
                </div>
              )}
              ...
              <footer className="mt-20 pt-10 border-t border-border">
                <div className="bg-card p-10 rounded-[32px] border border-border text-center">
                   ...
                   <p className="text-muted-foreground mb-8">Join our newsletter to receive the latest strategies for e-commerce growth.</p>
