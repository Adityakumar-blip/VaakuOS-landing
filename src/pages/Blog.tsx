        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              The Retrieval <span className="text-primary">Journal</span>.
            </h1>
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
              Insights, case studies, and strategies to help you scale your
              e-commerce revenue with intelligence.
            </p>
          </div>
                  ...
                  >
                    <div className="relative aspect-[21/9] bg-gradient-to-br from-primary/30 to-secondary/30 rounded-3xl overflow-hidden border border-border flex items-center justify-center p-12">
                      <div className="max-w-xl text-center">
                        ...
                        <div className="flex items-center justify-center gap-2 mx-auto font-bold text-primary group-hover:gap-4 transition-all">
