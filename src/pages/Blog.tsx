      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight pb-3 mb-4 bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/80">
            ...
            <>
              {featuredPost && (
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-20">
                  ...
                  >
                    <div className="relative aspect-auto md:aspect-[21/9] min-h-[350px] bg-gradient-to-br from-primary/30 to-secondary/30 rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-border flex items-center justify-center p-8 md:p-12">
                      <div className="max-w-xl text-center">
                        ...
                        <div className="flex items-center justify-center gap-2 mx-auto font-bold text-primary group-hover:gap-4 transition-all text-sm md:text-base">
                          Read the Article <ArrowRight className="h-5 w-5" />
                        </div>
                      </div>
                    </div>
                  </Link>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {regularPosts.map((post) => (
                  <Link key={post.id} to={`/blog/${post.slug}`}>
                    <Card className="p-6 md:p-8 border-border bg-card hover:shadow-xl transition-all group flex flex-col cursor-pointer h-full rounded-2xl">
                      <div className="flex items-center justify-between mb-4 md:mb-6">
                        <Badge
                          variant="secondary"
                          className="px-3 py-1 font-bold text-[10px] md:text-xs"
                        >
                          {post.category?.name || "Growth"}
                        </Badge>
                      </div>
                      <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 group-hover:text-primary transition-colors line-clamp-2 leading-snug">
                        {post.title}
                      </h3>
                      <p className="text-sm md:text-base text-muted-foreground mb-6 md:mb-8 line-clamp-3 leading-relaxed">
                        {post.excerpt ||
                          post.content
                            .substring(0, 150)
                            .replace(/<[^>]*>/g, "") + "..."}
        ...
        <div className="container mx-auto max-w-6xl px-4 mt-32">
          <section className="bg-primary py-20 md:py-24 rounded-[2rem] md:rounded-[3rem] text-primary-foreground text-center px-6">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-3xl font-bold mb-4 text-white">
                Get conversion insights in your inbox.
              </h2>
