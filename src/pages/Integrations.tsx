...
const Integrations = () => {
  const categories = [
      ...
      items: [
        {
          name: "Shopify",
          status: "Certified",
          desc: "Native sync for orders, carts, and customer data.",
        },
        {
          name: "WooCommerce",
          status: "Classic",
          desc: "Powerful plugin for WordPress stores.",
        },
        {
          name: "BigCommerce",
          status: "Partner",
          desc: "Scale your storefront with real-time recovery.",
        },
        {
          name: "Magento 2",
          status: "Enterprise",
          desc: "Robust integration for enterprise merchants.",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Zapier",
          status: "Unlimited",
          desc: "Connect with 5000+ apps via webhooks.",
        },
        {
          name: "HubSpot",
          status: "Certified",
          desc: "Sync recovery events to your CRM timeline.",
        },
        {
          name: "Salesforce",
          status: "Enterprise",
          desc: "Full lifecycle management for larger teams.",
        },
        {
          name: "Klaviyo",
          status: "Marketing",
          desc: "Combine AI recovery with email marketing.",
        },
      ],
    },
    // {
    ...
    //       name: "Slack",
    //       status: "Real-time",
    //       desc: "Get notifications for major recovered sales.",
    //     },
    //     {
    //       name: "Google Sheets",
    //       status: "Export",
    //       desc: "Automate your reporting and data analysis.",
    //     },
    //     {
    //       name: "Notion",
    //       status: "Wiki",
    //       desc: "Keep your recovery playbooks in sync.",
    //     },
    //     {
    //       name: "Discord",
    //       status: "Community",
    //       desc: "Webhook support for team alerts.",
    //     },
    //   ],
    // },
  ];
              ...
              <div key={idx}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {cat.items.map((item, i) => (
                    <Card
                      key={i}
                      className="p-6 border-border bg-card shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group cursor-pointer"
                    >
